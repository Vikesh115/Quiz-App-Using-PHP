...
<head>
    ...
    <meta name="author" content="Vikesh Raut">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="Vikesh, Raut, Free, Quiz, Open-Source, PHP">
        ...
        <form action="result.php" method="POST">
            <ol type="1">
                <div id="question-container">
                    <li>
                        <h2 class="question" id="1">What is the most well know fast food place?</h2>
                    </li>
